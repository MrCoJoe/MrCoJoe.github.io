import{_ as n,o as a,c as e,d as i}from"./app-BOLxB7eC.js";const l={};function p(r,s){return a(),e("div",null,s[0]||(s[0]=[i(`<h1 id="swagger模块" tabindex="-1"><a class="header-anchor" href="#swagger模块"><span>Swagger模块</span></a></h1><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>    找了一圈，发现还是swagger正统点。使用的swagger3.0，抛弃了原先的springfox，</span></span>
