...
![image.png](./img/BWeEMlqMrhVTEx6l/1680881576213-a621153d-1d8c-412b-9234-de1766d018a5-138599.png)

所以，布隆过滤器是存在误判的可能的，也就是当一个不存在的Hero元素，经过hash1、hash2和hash3之后，刚好和其他的值的哈希结果冲突了。那么就会被误判为存在，但是其实他并不存在。

![image.png](./img/BWeEMlqMrhVTEx6l/1680881991368-ad74c9de-fdef-4f7e-b4be-aad8364718e5-183330.png)
...
<!--page footer-->
- 原文: <https://www.yuque.com/hollis666/axzrte/gp9ymie1n39uavah>