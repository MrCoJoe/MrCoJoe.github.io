...
![](./img/aHs71X3VQbhy2EFF/16119907257353-581463.jpg)
...
> 当标度为负数时，这意味着该数在小数点左侧有若干个零。负数标度实际上表示的是该数以10的幂次放大的形式。例如，一个数值为12300，如果其标度为-2，则表示该数实际上是12300 * 10^(-2)，即123。
...
![](./img/aHs71X3VQbhy2EFF/16119945021181-373454.jpg)
...
<!--page footer-->
- 原文: <https://www.yuque.com/hollis666/axzrte/tv3ne5taonetgiip>