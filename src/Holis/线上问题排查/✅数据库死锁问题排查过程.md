...
![](./img/7jmgH_PI7zPUWbEF/15540129755807-871651.jpg)

updateFundStreamId执行的时候使用到的是PRIMARY索引。

![](./img/7jmgH_PI7zPUWbEF/15540130212992-320217.jpg)
...
![](./img/7jmgH_PI7zPUWbEF/15540203229844-257786.jpg)
...
![](./img/7jmgH_PI7zPUWbEF/15540203644300-848503.jpg)

死锁的发生与否，并不在于事务中有多少条SQL语句，**死锁的关键在于：两个(或以上)的Session加锁的顺序不一致。**那么接下来就看下上面的例子中两个事务的加锁顺序是怎样的：

![](./img/7jmgH_PI7zPUWbEF/15540203894387-377914.jpg)

下图是分解图，每一条SQL执行的时候加锁情况：

![](./img/7jmgH_PI7zPUWbEF/15540204145590-759958.jpg)
...
<!--page footer-->
- 原文: <https://www.yuque.com/hollis666/axzrte/yywypm>