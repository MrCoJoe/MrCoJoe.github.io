...
```java
interface PayFacade implements InitializingBean {
    void pay();
...
[事务失效可能是哪些原因？](https://www.yuque.com/hollis666/axzrte/bz0tulziboigw24b)


<!--page footer-->
- 原文: <https://www.yuque.com/hollis666/axzrte/xn5f5v>