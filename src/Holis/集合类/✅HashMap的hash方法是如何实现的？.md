...
![](./img/qHgATVOsqOjPbSjM/640-1-639422.png)

所以，`return h & (length-1);`只要保证length的长度是`2^n`的话，就可以实现取模运算了。而HashMap中的length也确实是2的幂，初始值是16，之后每次扩充为原来的2倍。

[✅为什么HashMap的Cap是2^n，如何保证？](https://www.yuque.com/hollis666/axzrte/ud3e99?view=doc_embed)
...
![](./img/qHgATVOsqOjPbSjM/640-2-658580.png)
...
<!--page footer-->
- 原文: <https://www.yuque.com/hollis666/axzrte/sz24zwwrdg92qizg>